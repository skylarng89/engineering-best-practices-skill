...
```bash
# Claude Code
cp SKILL.md ~/.claude/skills/engineering-best-practices-2026/SKILL.md

# Cursor
cp SKILL.md ~/.cursor/skills/engineering-best-practices-2026/SKILL.md
```

### MCP Discovery (`.well-known`)
If you self-host an MCP server, the skill is available at:
```
/.well-known/skills/index.json
/.well-known/agent-skills/engineering-best-practices-2026/skill.md
```
